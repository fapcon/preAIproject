...
type AuthClient interface {
	...
	SocialCallback(ctx context.Context, in *SocialCallbackRequest, opts ...grpc.CallOption) (*LoginResponse, error)
	// SocialGetRedirectURL generate redirect url
	SocialGetRedirectURL(ctx context.Context, in *SocialGetRedirectUrlRequest, opts ...grpc.CallOption) (*SocialGetRedirectUrlResponse, error)
}
...
func (c *authClient) RegisterApp(ctx context.Context, in *RegisterAppRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *authClient) SocialCallback(ctx context.Context, in *SocialCallbackRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, "/auth.Auth/SocialCallback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) SocialGetRedirectURL(ctx context.Context, in *SocialGetRedirectUrlRequest, opts ...grpc.CallOption) (*SocialGetRedirectUrlResponse, error) {
	out := new(SocialGetRedirectUrlResponse)
	err := c.cc.Invoke(ctx, "/auth.Auth/SocialGetRedirectURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	// SocialCallback callback to process answer from provider
	SocialCallback(context.Context, *SocialCallbackRequest) (*LoginResponse, error)
	// SocialGetRedirectURL generate redirect url
	SocialGetRedirectURL(context.Context, *SocialGetRedirectUrlRequest) (*SocialGetRedirectUrlResponse, error)
...
func (UnimplementedAuthServer) RegisterApp(context.Context, *RegisterAppRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterApp not implemented")
}
func (UnimplementedAuthServer) SocialCallback(context.Context, *SocialCallbackRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SocialCallback not implemented")
}
func (UnimplementedAuthServer) SocialGetRedirectURL(context.Context, *SocialGetRedirectUrlRequest) (*SocialGetRedirectUrlResponse, error) {
...
func _Auth_SocialCallback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SocialCallbackRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).SocialCallback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/SocialCallback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).SocialCallback(ctx, req.(*SocialCallbackRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Auth_SocialGetRedirectURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SocialGetRedirectUrlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).SocialGetRedirectURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/SocialGetRedirectURL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).SocialGetRedirectURL(ctx, req.(*SocialGetRedirectUrlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_SocialCallback_Handler,
		},
		{
			MethodName: "SocialGetRedirectURL",
			Handler:    _Auth_SocialGetRedirectURL_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pb/sso/sso.proto",
}
