...
import (
	"studentgit.kata.academy/eazzyearn/students/mono/monolith/internal/modules/exchange_client/controller"
...
// swagger:route GET /api/1/exchange/ticker exchange ticker
// Получение курса криптовалют, тикера.
// security:
//   - Bearer: []
// responses:
//   200: exchangeTickerResponse

// swagger:response exchangeTickerResponse
type exchangeTickerResponse struct {
	// in:body
	Body pcontroller.TickerResponse
}

// swagger:route GET /api/1/exchange/list exchange ticker
// Получение списка бирж торговли.
// security:
//   - Bearer: []
// responses:
