...
type UserDTO struct {
	...
	ResetCode     int              `json:"reset_code" db:"reset_code" db_type:"integer" db_default:"default null" db_ops:"create,update"`
...
func (u *UserDTO) SetResetCode(resetCode int) *UserDTO {
	u.ResetCode = resetCode
	return u
}

func (u *UserDTO) GetResetCode() int {
	return u.ResetCode
}
